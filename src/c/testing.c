...
int main(int argc, char *argv[])
	...
	int items = 50000;		// Items per iteration
	int iterations = 40;	// Number of iterations
	int prefill = 0;		// Items to write before testing
	int noise = 0;			// Random elements added/removed (can be negative)
	
	int Adim = 1000;		// Hyperparameters
	int Apop = 10;
	int Bdim = 1001;		// Auto-associative if Bdim == Bpop == 0
	int Bpop = 10;
